...
//5.. Bubble Chart of all emotions relationship with happiness
...
//       title: {
//         display: true,
//         text: 'Relationship of Happiness vs Fear per political party'
//       }, scales: {
//         yAxes: [{
//           scaleLabel: {
//             display: true,
...
var don = document.getElementById("myChartFive");
var testy = new Chart(don, {
  type: 'scatter',
  data: {
    labels: ["Male", "Females"],
    datasets: [{
      label: 'Relationship of Gisgust & Fear',
      data: [maleAveContempt(), femaleAveContempt()],
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(54, 162, 235, 0.2)',
